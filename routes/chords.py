...
Rute: 
- POST /search-chords (cu cache integrat)
- POST /api/chords/save (salveaza acorduri favorite)
- GET /api/chords/saved (extrage acorduri favorite)
- DELETE /api/chords/saved/<id> (sterge acorduri favorite)
"""
